...
public class Combo {
    ...
    public void addDish(Dish dish) {
        if (dishes[0] == null) {
            ...
            System.out.printf("There are already %d dishes, failure to add new dish.", MAX_DISH_NUM);
        }
    }
    public void addBeverage(Beverage beverage) {
        if (beverages[0] == null) {
            ...
            System.out.printf("There are already %d beverages, failure to add new beverage.", MAX_BEVERAGE_NUM);
        }
    }
